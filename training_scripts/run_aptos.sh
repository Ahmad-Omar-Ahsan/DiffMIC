export EXP_DIR=./results_aptos_baseline_1000
export N_STEPS=1000
...
export MODEL_VERSION_DIR=diffmic_conditional_results/${N_STEPS}steps/nn/${RUN_NAME}/${PRIOR_TYPE}${CAT_F_PHI}/${F_PHI_TYPE}
